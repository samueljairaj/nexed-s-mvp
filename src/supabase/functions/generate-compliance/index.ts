...
import { DocumentCategory } from "../../../types/document"; // This import won't work in edge functions
...
// Explicitly define DocumentCategory for the edge function since it can't import from client code
type DocumentCategoryEdge = "immigration" | "education" | "employment" | "personal" | "financial" | "other" | "academic";
