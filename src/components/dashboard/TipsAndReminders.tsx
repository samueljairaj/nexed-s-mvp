...
const TipsAndReminders: React.FC<TipsAndRemindersProps> = ({
  ...
  return <Card className="h-full hover:shadow-card-hover transition-shadow duration-300 mx-[100px]">
      ...
      <CardContent className="p-4 pt-0 space-y-4">
        <div className="space-y-2">
          {tips.map((tip, index) => <div key={index} className="flex items-center p-2 bg-nexed-50 rounded-lg hover:bg-nexed-100 transition-colors duration-200">
